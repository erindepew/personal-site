        ...
        <div className="about--MAIN">
            <img className="about--profile-image" src="images/profile-pic.png"/>
                <div className="about--text-wrapper">
                    <p className="about--text">I am a front-end developer and web designer currently living in Brooklyn and working in Manhattan. Whether you consider me a designer with programming skills,
