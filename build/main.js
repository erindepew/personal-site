...
var Button = React.createClass({displayName: "Button",
  ...
  render: function () {
    return (
      React.createElement("button", {onClick: this.handleClick, className: `button--${this.props.aspect}`}, this.props.label)
    );
  }
});
    ...
    return (
      React.createElement("div", {className: "filter--MAIN"}, 
        ...
        this.props.buttons.map(function (item) {
          return React.createElement(Button, {label: item, aspect: "AlTERNATE", ref: item});
        })
      )
    );
  }
...
var Work = React.createClass({displayName: "Work",
  ...
  render: function () {
    ...
    return (
      React.createElement("div", {className: "layout--MAIN"}, 
        React.createElement("div", {className: `layout--wrapper ${this.props.navState ? 'layout--wrapper open' : 'layout--wrapper closed'}`}, 
          React.createElement(Filter, {label: "Filter by", buttons: filterOptions, onClick: this.handleClick}), 
          length.map(function (item, index) {
            return (
            work.map(function (item) {
              if (item[index]) {
                return React.createElement(Thumbnail, {text: item[index].text, title: item[index].title, imageUrl: `portfolio/${item[index].image}`});
              }
            }));
          })
        )
