...
var Button = React.createClass({displayName: "Button",
  render: function () {
    return (
      React.createElement("button", {onClick: this.props.handleClick ? this.props.handleClick.bind(null, this.props.label) : null, className: `button--${this.props.aspect}`}, this.props.label)
    );
  }
});
    ...
    return (
      React.createElement("div", {className: "filter--MAIN"}, 
        ...
        this.props.buttons.map(function (item) {
          return React.createElement(Button, {label: item, aspect: "AlTERNATE", ref: item, handleClick: clickFunction});
        })
      )
    );
  }
        ...
        React.createElement("div", {className: `layout--wrapper ${this.props.navState ? 'layout--wrapper open' : 'layout--wrapper closed'}`}, 
          ...
          React.createElement("div", {className: "portfolio-page--MAIN"}, 
            ...
            currentProject.content.map(function(item){
              return (
                React.createElement("div", null, 
                  React.createElement("img", {className: "thumbnail--image", src: `images/portfolio/${item.image}`}), 
  ...
  render: function () {
    ...
    return (
      React.createElement("div", {className: "layout--MAIN"}, 
        React.createElement("div", {className: `layout--wrapper ${this.props.navState ? 'layout--wrapper open' : 'layout--wrapper closed'}`}, 
          React.createElement("div", {className: "layout--primary-section"}, 
            React.createElement(Filter, {label: "Filter by", buttons: filterOptions, handleClick: this.handleClick}), 
            work.map(function (item) {
                  return React.createElement(Thumbnail, {text: item.text, title: item.title, imageUrl: `portfolio/${item.image}`, link: `/work/${item.name}`});
                }) 
          )
        ), 
        React.createElement(Navigation, {navState: this.props.navState})
