          ...
          React.createElement("div", {className: "layout--primary-section"}, 
            ...
            length.map(function (item, index) {
              ...
              work.map(function (item) {
                if (item[index]) {
                  return React.createElement(Thumbnail, {text: item[index].text, title: item[index].title, imageUrl: `portfolio/${item[index].image}`, link: `/work/${item[index].name}`});
                }
              }));
            })
          )
