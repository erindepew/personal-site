  ...
  render: function () {
    return (
      React.createElement("div", null, 
        React.createElement("span", {className: "nav--mobile-icon", onClick: this.navClick}, " navigation mobile icon"), 
