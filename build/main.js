...
var Button = React.createClass({displayName: "Button",
  render: function () {
    return (
      React.createElement("button", {onClick: this.props.handleClick ? this.props.handleClick.bind(null, this.props.label) : null, className: `button--${this.props.aspect} ${this.props.selected ? 'selected' : null}`}, this.props.label)
    );
  }
});
    ...
    return (
      React.createElement("div", {className: "filter--MAIN"}, 
        ...
        this.props.buttons.map(function (item) {
          return React.createElement(Button, {label: item, aspect: "AlTERNATE", ref: item, selected: selected == item, handleClick: clickFunction});
        })
      )
    );
  }
