          ...
          React.createElement("div", {className: "layout--primary-section"}, 
            ...
            length.map(function (item, index) {
              ...
              work.map(function (item) {
                if (item[index]) {
                  debugger;
                  return React.createElement(Link, {to: `/work/${item[index].name}`}, React.createElement(Thumbnail, {text: item[index].text, title: item[index].title, imageUrl: `portfolio/${item[index].image}`}));
                }
              }));
            })
          )
