    ...
    return (
      React.createElement("div", {className: `filter--MAIN${selected ? `-SELECTED` : ``}`}, 
        ...
        this.props.buttons.map(function (item) {
          return React.createElement(Button, {label: item, aspect: "ALTERNATE", ref: item, selected: selected == item, handleClick: (selected == item || !selected) ? clickFunction : null});
        })
      )
    );
  }
